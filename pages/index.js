      ...
      <HeadComponent
        ...
        FAQProps={[
          ...
          },
          {
            ...
            answer:
              "FinFloh reduces DSO by automating collections workflows, enabling risk-based prioritization, embedding structured credit controls directly within CRM systems, and triggering internal alerts and escalations for delayed payments. This improves working capital efficiency and accelerates cash recovery.",
          },
          {
            question:
          ...
          },
          {
            ...
            answer:
              "Yes. FinFloh integrates with leading ERP systems such as Oracle NetSuite, Oracle Fusion, Microsoft Dynamics 365, and SAP S/4HANA. By synchronizing receivables data, it eliminates manual reconciliation, improves cross-functional visibility, and ensures structured credit controls within customer onboarding workflows.",
          },
          {
            question:
              "What is automated credit risk scoring and decisioning in FinFloh?",
            answer:
              "Automated credit risk scoring evaluates customers using financial data, behavioral signals, and predefined risk parameters. FinFloh translates risk scores into actionable credit onboarding recommendations directly within CRM workflows, standardizing approvals and reducing bad debt exposure.",
          },
          {
