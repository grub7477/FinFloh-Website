...
const DemoRequestSuccessful = ({ isFreeTrail=false }) => (
  <>
    <WebsiteLayout>
      <div className="bg-container">
        <div className="container-main">
          ...
          >
            ...
            <img src="/images/green-tick.svg" alt="green tick finfloh"></img>
            <p>
              {isFreeTrail
                ? "You can expect an email from our business team shortly to help you with your onboarding for the free trial."
                : "You can expect an email from our business team shortly to confirm the date and time slot for your personalized demo."}
            </p>
...
export default DemoRequestSuccessful;
